defmodule HermesTrictrac.Rules.DiceTest do
  use ExUnit.Case, async: true

  alias HermesTrictrac.Rules.Dice
  ...
  test "crypto roller returns values in range for one two and three dice" do
    Application.delete_env(:hermes_trictrac, :dice_impl)
  ...
  test "exclude_doubles is ignored for a single die" do
    Application.put_env(:hermes_trictrac, :dice_impl, Deterministic)
