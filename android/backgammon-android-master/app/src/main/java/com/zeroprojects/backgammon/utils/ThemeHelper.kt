package com.zeroprojects.backgammon.utils
...
object ThemeHelper {
    ...
    fun createRect(context:Context ,@ColorRes color: Int, radius: Int, @ColorRes strokeColor: Int, strokeWidth: Int): GradientDrawable {
        val gradientDrawable = createRect(color, radius)
        gradientDrawable.setStroke(
            DimensionUtils.dpToPx(strokeWidth.toFloat()).toInt(),
