...
const LOCALE_OVERRIDES = {
  de: {
    ...
    options: {
      ...
      doublesMode: "Paschwertung",
      enableMargot: "Margot aktivieren",
      targetHoles: "Ziellöcher",
      doubleScoring: "Paschwertung",
      doublesOn: "Paschwertung an",
      doublesOff: "Paschwertung aus",
      bestOf: "Best-of",
      bestOfN: "Best of {count}",
  ...
  fr: {
    ...
    game: {
      ...
      wonBy: "Victoire de {winner} par {kind}.",
      wonByPoints: "Victoire de {winner} par {points}.",
    ...
    matchResult: {
      gameDraw: "Partie {number} : {kind}{award}",
      gameWin: "Partie {number} : {leg}victoire de {winner}{award} par {kind}"
    },
    errors: {
  ...
  sv: {
    ...
    game: {
      ...
      tavliAgreement: "Tavli-målet måste avtalas före spelstart.",
      margotAgreement: "Margot la fendue måste avtalas före spelstart.",
      optionsAgreement: "Matchalternativen måste bekräftas före spelstart.",
      decisionRequired: "{player} måste fatta ett beslut för turen.",
    ...
    options: {
      ...
      doublesMode: "Dubbelkast",
      margot: "Margot la fendue",
      enableMargot: "Aktivera Margot",
      targetHoles: "Hålmål",
      doubleScoring: "Dubbel räkning",
      doublesOn: "Dubbelkast på",
      doublesOff: "Dubbelkast av",
      bestOf: "Bäst av",
    ...
    errors: {
      ...
      turn_obligations: "Turens skyldigheter är inte uppfyllda.",
      coin_rest: "Coin de repos måste avsluta turen med 0 eller minst 2 brickor.",
  ...
  da: {
    ...
    game: {
      ...
      decisionRequired: "{player} skal træffe en beslutning for turen.",
    ...
    options: {
      ...
      doublesMode: "Dobbeltslag",
      margot: "Margot la fendue",
      enableMargot: "Aktivér Margot",
      targetHoles: "Hulmål",
      doubleScoring: "Dobbelt optælling",
      doublesOn: "Dobbeltslag til",
      doublesOff: "Dobbeltslag fra",
      bestOf: "Bedst af",
    ...
    errors: {
      ...
      coin_rest: "Coin de repos skal afslutte turen med 0 eller mindst 2 brikker.",
